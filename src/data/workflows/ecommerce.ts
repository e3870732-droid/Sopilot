...
export const ecommerceWorkflow: RoleWorksheet = {
  ...
  steps: [
    {
      title: "选品与定价",
      action: "分析市场趋势与品类结构，规划引流款、利润款和形象款，完成定价与备货。",
      owner: "品类运营",
      handoff: "与供应链确认供货与补货。",
      proof: "月度选品清单 + 备货记录",
      tags: ["not_documented", "no_templates"]
    },
    {
      title: "店铺与货架",
      ...
      proof: "详情页 + 活动报名记录",
      tags: ["no_templates", "inconsistent_standards"]
    },
    {
      title: "流量与直播",
      ...
      proof: "投放报表 + 直播排期",
      tags: ["priority_chaos", "handoff_churn"]
    },
    {
      title: "转化与履约",
      ...
      proof: "发货台账 + 售后记录",
      tags: ["missing_checks", "unclear_ownership"]
    },
    {
      title: "复盘与补货",
